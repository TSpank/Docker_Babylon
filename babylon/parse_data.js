function parse_data(skeleton,values,angles)
{
	...
	if ( false ) //angles != null )
	{
		...
		var rotation_lower = BABYLON.Quaternion.FromEulerAngles(0.0,0.0,gamma_lower_r);
		skeleton.bones[35].getTransformNode().rotationQuaternion.multiplyInPlace(rotation_lower);
		skeleton.bones[11].getTransformNode().rotationQuaternion.multiplyInPlace(BABYLON.Quaternion.Inverse(rotation_lower));
